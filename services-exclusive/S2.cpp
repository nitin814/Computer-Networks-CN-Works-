...
int main (){
    ...
    cout<<" -- Service 2 up and running --"<<endl;
    ...
    dup2(0,first_client);
    {
        ...
        cout<<"here"<<endl;
        pthread_t t;
        int temp = pthread_create(&t, NULL ,service2,temp1);
        pthread_join(t,NULL);
    }
